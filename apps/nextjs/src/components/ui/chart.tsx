...
// Define types for chart payload items
    ...
    >
      ...
      <div className="grid gap-1.5">
        {payload.map((item, index: number) => {
          const chartItem = item as ChartPayloadItem;
            ...
            >
              {formatter && chartItem.value !== undefined && chartItem.name ? (
                formatter(
                  ...
                  item,
                  index,
                  // Pass the full tooltip payload array as required by recharts
                  payload,
                )
              ) : (
                <>
          ...
          >
            {itemConfig?.icon && !hideIcon ? (
              ...
              <div
                ...
                style={{
                  backgroundColor: chartItem.color ?? "currentColor",
                }}
              />
            )}
            {itemConfig?.label}
